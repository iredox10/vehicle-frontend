...
import { useEffect, useState, useuser } from "react";
    ...
    <div className="w-[60%] my-5 mx-auto  bg-green-700/20  ">
      <div className=" bg-green-500 p-5 ">
        <div className="flex">
          <div className="flex items-center gap-3">
            <div className="w-[15%]">
              <img src={jigawa_logo} alt="Jigawa user Logo" />
            </div>
            <h1 className="text font-bold capitalize ">
              jigawa user <span className="block"> Internal </span>Revenue
              Service (JIRS)
            </h1>
          </div>
          <div className=" mb-5">
      ...
      <div className="capitalize flex justify-between px-16 py-5">
        <div>
          <p className="mb-2">
            Owner
            <span className="font-bold block text-xl ">{user?.ownerName}</span>
          </p>
          <p className="mb-2">
            vehicle Make
      ...
      <div className=" flex justify-end pr-16 py-2">
        <QRCodeComponent value={user?.onwerName} />
      </div>
    </div>
  );
}
